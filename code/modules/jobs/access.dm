...
//NSV13 - Added ACCESS_MUNITIONS, ACCESS_MAA, ACCESS_FIGHTER, ACCESS_FL, ACCESS_MINING_ENGINEERING, ACCESS_MINING_BRIDGE
...
/proc/get_all_jobs()//Nsv13 - updated with new jobs
	return list("Midshipman", "Captain", "Executive Officer", "Bartender", "Cook", "Botanist", "Quartermaster", "Cargo Technician",
				"Shaft Miner", "Clown", "Mime", "Janitor", "Curator", "Lawyer", "Chaplain", "Chief Engineer", "Engineer", //RuNsv13 Station Engineer -> engineer
