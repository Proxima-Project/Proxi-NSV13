...
/obj/item/banner/security
	...
	lefthand_file = 'icons/mob/inhands/equipment/banners_lefthand.dmi'
	righthand_file = 'icons/mob/inhands/equipment/banners_righthand.dmi'
	job_loyalties = list("Military Police", "Warden", "Detective", "Head of Security", "Brig Physician", "Deputy")  //Nsv13 - Crayon eaters & MPs
...
/obj/item/banner/engineering
	...
	lefthand_file = 'icons/mob/inhands/equipment/banners_lefthand.dmi'
	righthand_file = 'icons/mob/inhands/equipment/banners_righthand.dmi'
	job_loyalties = list("Engineer", "Atmospheric Technician", "Chief Engineer") //RuNsv13 Station Engineer -> engineer
